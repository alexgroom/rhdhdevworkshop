...
When the workshop starts you should be presented with a url for the OpenShift console access and a password. 
...
*KeyCloak* will redirect to the Developer Hub (RHDH) home screen. 
